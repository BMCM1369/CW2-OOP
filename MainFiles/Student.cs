...
namespace User_Class
{
    public class Student : User
    {
        ...
        public List<string> CompletedQuizzes
        {
            ...
            set { CompletedQuizzes = value; } //Constructors with get and set for attributes listed in the UML diagram
        }
        ...
        public static Student CreateSampleStudent() //This is the method that creates a sample student for testing purposes
        {
            return new Student(
                userId: 1,
        ...
        public static void DisplayStudentMenu(Student student) //This is the student menu method that displays options for the student to choose from
        {
            if (student == null)
            {
        ...
        private static void UpdateStudentScore(Student student) //This is the method that allows the student to update their score when takin a quiz
        {
            Console.Clear();
        ...
        private static void SubmitQuiz(Student student) //This method allows the user to submit a quiz and updates their score accordingly
        {
            Console.Clear();
